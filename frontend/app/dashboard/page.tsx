  ...
  const fetchDashboardData = async () => {
    ...
    try {
      if (viewMode === 'resources') {
        const response = await fetch('https://dplanner.westeurope.cloudapp.azure.com:8000/api/dashboard/resources');
        ...
        const response = await fetch('https://dplanner.westeurope.cloudapp.azure.com:8000/api/dashboard/projects');
